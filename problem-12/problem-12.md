...
The system must determine whether a customer can receive a loan and calculate the maximum loan amount based on:
...
age = 30 salary = 2000 employment = employed creditScore = 720

Loan approved. Maximum loan amount: $6000

Your Tasks
Students must:

Create the algorithm in JavaScript
Design the flowchart diagram
Use nested conditionals (if, else if, else)
Validate all inputs
Calculate the maximum loan amount if approved
Learning Goals
